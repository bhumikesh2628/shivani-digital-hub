...
export default function ImportExportModification() {
  const { t } = useLanguage()
  useEffect(() => {
    document.title = "Import Export Modification Registration | Shivani Digital Hub";
  }, []);
  ...
  const onSubmit = async e => {
    ...
    const serviceName = `IEC Modification`
    const message = `IEC Modification Inquiry:\n\nName: ${form.name}\nPhone: ${form.phone}\nEmail: ${form.email}\nState: ${form.state}`
      ...
      <div style={{ fontFamily: "'Inter', Arial, Helvetica, sans-serif", fontSize: '15px' }} className="bg-white min-h-screen text-slate-900 leading-relaxed">
        ...
        <section className="relative w-full pt-[110px] md:pt-[220px] pb-8 md:py-16 border-b border-slate-200/50 overflow-hidden">
          ...
          <div className="absolute inset-0 w-full h-[200px] md:h-full top-0 left-0 pointer-events-none select-none z-0">
            <img
              src="/iec_modification_hero_bg.webp"
              alt="IEC Modification Background"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 text-left animate-slide-left">
                ...
                <nav className="text-xs md:text-sm text-slate-500 font-semibold tracking-wide mb-3">
                  Home <span className="mx-1 text-slate-400">»</span> IEC Modification
                </nav>
              ...
              <div className="lg:col-span-5 w-full max-w-md mx-auto animate-slide-right" id="registration-form">
                <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-[0_15px_35px_rgba(0,0,0,0.05)] border border-slate-100 w-full relative">
                  <div className="text-center mb-4">
                    <h3 className="font-poppins font-black text-lg sm:text-[20px] text-[#991b1b] mb-1.5">{t("Modify Your IEC Now")}</h3>
                  ...
                  <form onSubmit={onSubmit} className="space-y-3">
                    ...
                    <div className="pt-1.5">
                      ...
                      >
                        {loading ? <><i className="fas fa-spinner fa-spin mr-2"></i> Modifying...</> : 'Get Started'}
                      </button>
                    </div>
        ...
        <section className="py-16 sm:py-20 bg-white" id="overview">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <h2 className="text-2xl sm:text-3.5xl font-poppins font-extrabold text-slate-900 mt-2 tracking-tight">Understanding IEC Modification</h2>
        ...
        <section className="py-16 sm:py-20 bg-[#fff5ec] border-y border-orange-100/50" id="benefits">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <h2 className="text-2xl sm:text-3.5xl font-poppins font-extrabold text-slate-900 mt-2 tracking-tight">Advantages of Modifying Your IEC</h2>
              <div className="w-16 h-1 bg-[#f0c040] mx-auto rounded-full mt-4"></div>
            </div>
        ...
        <section className="py-16 sm:py-20 bg-white" id="documents">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <h2 className="text-2xl sm:text-3.5xl font-poppins font-extrabold text-slate-900 mt-2 tracking-tight">Documents Checklist for IEC Modification</h2>
              <div className="w-16 h-1 bg-[#f0c040] mx-auto rounded-full mt-4"></div>
            </div>
        ...
        <section className="py-16 sm:py-20 bg-[#f4faff] border-y border-sky-100/50" id="decide-name">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <h3 className="text-xl sm:text-2xl font-poppins font-extrabold text-slate-900 mt-2">IEC Modification Guidelines & Portal Rules</h3>
              <div className="w-16 h-1 bg-[#f0c040] mx-auto rounded-full mt-4"></div>
            </div>
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-12 max-w-6xl mx-auto items-start">
              ...
              <div className="text-left reveal-card">
                <span className="text-xs sm:text-sm font-extrabold tracking-[2px] uppercase text-[#d97706] block mb-2 font-poppins">MODIFICATION WITH CSC SHIVANI</span>
                <h3 className="text-2xl sm:text-[28px] font-extrabold text-slate-900 tracking-tight mb-8 font-poppins leading-tight">IEC Modification in Three Easy Steps!</h3>
                ...
                <div className="relative space-y-10 pl-4 border-l-2 border-sky-100/70 ml-2">
                  ...
                  <div className="relative">
                    ...
                    <div className="pl-6">
                      <h4 className="font-bold text-[#00509d] text-[15px] sm:text-base mb-2 font-poppins">1. Provide Modifications & Upload</h4>
                      <ul className="list-disc pl-4 space-y-1.5 text-slate-700 text-xs sm:text-[13.5px] leading-relaxed">
                        <li>Detail the modifications needed (address, bank, partners, etc.)</li>
                        <li>Upload supportive modified documents (such as rent deed, utility bills)</li>
                        <li>Initialize secure portal filing</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="pl-6">
                      <h4 className="font-bold text-[#00509d] text-[15px] sm:text-base mb-2 font-poppins">2. Portal Drafting & Digital Signature</h4>
                      <ul className="list-disc pl-4 space-y-1.5 text-slate-700 text-xs sm:text-[13.5px] leading-relaxed">
                        <li>Our legal team logs into the official DGFT portal on your behalf</li>
                        <li>We draft the online modification form including the updated parameters</li>
                        <li>Validate filings via your Class 3 DSC or Aadhaar OTP authentication</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="pl-6">
                      <h4 className="font-bold text-[#00509d] text-[15px] sm:text-base mb-2 font-poppins">3. Government Approval & Delivery</h4>
                      <ul className="list-disc pl-4 space-y-1.5 text-slate-700 text-xs sm:text-[13.5px] leading-relaxed">
                        <li>Pay the statutory government modification fee</li>
                        <li>Monitor processing status with the licensing authority</li>
                        <li>Download and deliver the newly modified official IEC certificate</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div className="text-left reveal-card">
                ...
                <h3 className="text-2xl sm:text-[28px] font-extrabold text-slate-900 tracking-tight mb-8 font-poppins leading-tight">Quickest Modification Timeline</h3>
                ...
                <div className="relative space-y-10 pl-4 border-l-2 border-emerald-100/70 ml-2">
                  ...
                  <div className="relative">
                    ...
                    <div className="pl-6">
                      ...
                      <ul className="list-disc pl-4 space-y-1.5 text-slate-700 text-xs sm:text-[13.5px] leading-relaxed">
                        <li>Verifying submitted modified proofs and drafting DGFT portal filing</li>
                        <li>Verifying DSC and linking active PAN variables</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  {/* Days 3-4 */}
                  <div className="relative">
                    <div className="absolute -left-[32px] top-0 w-8 h-8 rounded-full bg-emerald-100 text-emerald-600 font-extrabold flex items-center justify-center text-[9px] shadow-sm border border-white select-none">DGFT</div>
                    <div className="pl-6">
                      <h4 className="font-bold text-emerald-600 text-[15px] sm:text-base mb-2 font-poppins">Days 3 - 4</h4>
                      <ul className="list-disc pl-4 space-y-1.5 text-slate-700 text-xs sm:text-[13.5px] leading-relaxed">
                        <li>Filing the formal modification form and paying government statutory fees</li>
                        <li>Obtaining licensing officer approval and generating newly updated IEC certificate</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 pl-6">
                  <button type="button" onClick={(e) => scrollToSection(e, 'registration-form')} className="inline-block bg-[#e0b030] hover:bg-[#d97706] text-white font-extrabold text-[12px] px-6 py-2.5 rounded-lg tracking-wide uppercase select-none shadow-sm transition-all duration-300 cursor-pointer">Modify Your IEC Today!</button>
                </div>
              </div>

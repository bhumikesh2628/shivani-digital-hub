...
const init = { name: '', email: '', phone: '', state: '', plan: 'Individual / Startup' }
const states = ['Andhra Pradesh', 'Arunachal Pradesh', 'Assam', 'Bihar', 'Chhattisgarh', 'Delhi', 'Goa', 'Gujarat', 'Haryana', 'Himachal Pradesh', 'Jharkhand', 'Karnataka', 'Kerala', 'Madhya Pradesh', 'Maharashtra', 'Manipur', 'Meghalaya', 'Mizoram', 'Nagaland', 'Odisha', 'Punjab', 'Rajasthan', 'Sikkim', 'Tamil Nadu', 'Telangana', 'Tripura', 'Uttar Pradesh', 'Uttarakhand', 'West Bengal']

export default function TrademarkServices() {
  const { t } = useLanguage()
  useEffect(() => {
    document.title = "Trademark Services Registration | Shivani Digital Hub";
  }, []);
  ...
  const onSubmit = async e => {
    ...
    const serviceName = `Trademark Services - ${form.plan}`
    const message = `Trademark Services Inquiry:\n\nName: ${form.name}\nPhone: ${form.phone}\nEmail: ${form.email}\nState: ${form.state}\nPlan: ${form.plan}`
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 text-left animate-slide-left">
                  ...
                  <nav className="text-xs md:text-sm text-slate-500 font-semibold tracking-wide mb-3">
                    Home <span className="mx-1 text-slate-400">»</span> Trademark Registration
                  </nav>
                  ...
                  <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-4 sm:gap-5 mt-6 pt-6 border-t border-slate-200">
                    <div className="flex items-center gap-2 text-xs sm:text-[13px] font-bold text-slate-800">
                      ...
                      <span>5,000+ Brands Protected</span>
                    </div>
                    <div className="flex items-center gap-2 text-xs sm:text-[13px] font-bold text-slate-800">
                      <span className="w-6.5 h-6.5 rounded-full bg-green-100 text-green-600 flex items-center justify-center text-xs shrink-0 animate-pulse-slow">
              ...
              <div className="lg:col-span-5 w-full max-w-md mx-auto animate-slide-right" id="registration-form">
                <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-[0_15px_35px_rgba(0,0,0,0.05)] border border-slate-100 w-full relative">
                  <div className="text-center mb-4">
                    <h3 className="font-poppins font-black text-lg sm:text-[20px] text-[#991b1b] mb-1.5">{t("Protect Your Brand Name")}</h3>
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <h2 className="text-2xl sm:text-3.5xl font-poppins font-extrabold text-slate-900 mt-2 tracking-tight">
                Trademark Registration & Objection Services in India
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-12 text-left space-y-6">
                <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                  A trademark is a unique visual symbol, logo, signature, name, device, label, numerical, or combination of colors used by an enterprise to distinguish its goods or services from other similar products in the marketplace. It is regulated under the Trade Marks Act, 1999. Registering your trademark grants exclusive legal ownership rights to use the brand and prevents unauthorized copycats or infringements.
                </p>
                <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
                  Our professional CA/CS and legal team handles the complete brand protection lifecycle. We conduct comprehensive trademark database searches, select the proper classes out of the 45 available categories, draft Form TM-A, prepare necessary Power of Attorney files, and file the application to generate the immediate "TM" symbol status. We also provide robust objection replies to Section 9/11 examination reports.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 sm:py-20 bg-white" id="documents">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <h2 className="text-2xl sm:text-3.5xl font-poppins font-extrabold text-slate-900 mt-2 tracking-tight">
                Documents Required for Online Trademark Filing
              </h2>
              <div className="w-16 h-1 bg-[#f0c040] mx-auto rounded-full mt-4"></div>
            </div>
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <h3 className="text-xl sm:text-2xl font-poppins font-extrabold text-slate-900 mt-2">
                Guidelines for Selecting a Trademark Name
              </h3>
              <div className="w-16 h-1 bg-[#f0c040] mx-auto rounded-full mt-4"></div>
            </div>
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-12 max-w-6xl mx-auto items-start">
              ...
              <div className="text-left reveal-card">
                ...
                <div className="relative space-y-10 pl-4 border-l-2 border-sky-100/70 ml-2">
                  ...
                  <div className="relative">
                    ...
                    <div className="pl-6">
                      <h4 className="font-bold text-[#00509d] text-[15px] sm:text-base mb-2 font-poppins">1. Brand Search & Package</h4>
                      <ul className="list-disc pl-4 space-y-1.5 text-slate-700 text-xs sm:text-[13.5px] leading-relaxed">
                        <li>Pick the appropriate registration package</li>
                        <li>Submit your brand name, tagline, or logo softcopy</li>
                        <li>Our legal experts perform a comprehensive public search</li>
                  ...
                  <div className="relative">
                    ...
                    <div className="pl-6">
                      <h4 className="font-bold text-[#00509d] text-[15px] sm:text-base mb-2 font-poppins">2. Legal Drafting & Filing</h4>
                      <ul className="list-disc pl-4 space-y-1.5 text-slate-700 text-xs sm:text-[13.5px] leading-relaxed">
                        <li>We draft the formal Power of Attorney (POA) document</li>
                        <li>We identify the correct trade classes representing your brand</li>
                        <li>We file the Form TM-A application on the IP India portal</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="pl-6">
                      <h4 className="font-bold text-[#00509d] text-[15px] sm:text-base mb-2 font-poppins">3. Start Using "TM" Symbol</h4>
                      <ul className="list-disc pl-4 space-y-1.5 text-slate-700 text-xs sm:text-[13.5px] leading-relaxed">
                        <li>We provide you the official filing receipt in 1-2 days</li>
                        <li>You can legally start using the "TM" symbol immediately</li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className="text-left reveal-card">
                ...
                <h3 className="text-2xl sm:text-[28px] font-extrabold text-slate-900 tracking-tight mb-8 font-poppins leading-tight">
                  Trademark Filing & Registration Flow
                </h3>
                ...
                <div className="relative space-y-10 pl-4 border-l-2 border-emerald-100/70 ml-2">
                  ...
                  <div className="relative">
                    ...
                    <div className="pl-6">
                      ...
                      <ul className="list-disc pl-4 space-y-1.5 text-slate-700 text-xs sm:text-[13.5px] leading-relaxed">
                        <li>Comprehensive public search in trademark database</li>
                        <li>Drafting Power of Attorney (POA) and user affidavit (if applicable)</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="pl-6">
                      ...
                      <ul className="list-disc pl-4 space-y-1.5 text-slate-700 text-xs sm:text-[13.5px] leading-relaxed">
                        <li>Form TM-A filing with government fee payment</li>
                        <li>Filing receipt generated and "TM" status active</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="pl-6">
                      <h4 className="font-bold text-emerald-600 text-[15px] sm:text-base mb-2 font-poppins">Months 18 - 24</h4>
                      <ul className="list-disc pl-4 space-y-1.5 text-slate-700 text-xs sm:text-[13.5px] leading-relaxed">
                        <li>Awaiting examiner check and publication in Trademark Journal</li>
                        <li>Final Registration Certificate issued and "R" symbol active</li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="mt-8 pl-6">
                  <div className="inline-block bg-[#e0b030] hover:bg-[#d97706] text-white font-extrabold text-[12px] px-6 py-2.5 rounded-lg tracking-wide uppercase select-none shadow-sm transition-all duration-300">
                    Get Your Brand Protected Today!
                  </div>
                </div>
              </div>

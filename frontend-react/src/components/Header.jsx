...
export default function Header() {
  ...
  return (
    <>
      <header ref={headerRef} className={`sticky top-0 z-[1000] transition-all duration-300 border-b ${scrolled ? 'bg-white/80 border-slate-200/80 shadow-sm' : 'bg-white border-slate-100/50 shadow-[0_2px_15px_rgba(0,0,0,0.01)]'}`} style={scrolled ? { backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)' } : {}} id="header">
